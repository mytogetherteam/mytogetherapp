      ...
      children: [
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                context.tr('food.popular_dishes'),
          ...
          child: GridView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return FoodMenuItemCard(
                ...
                reviewCount: dish['reviewCount'] as int? ?? dish['ratingCount'] as int? ?? 0,
                distanceKm: (dish['distanceKm'] as num?)?.toDouble(),
                estimatedTime: dish['estimatedTime'] as String?,
                deliveryFee: dish['deliveryFee'] as String?,
                originalDeliveryFee: dish['originalDeliveryFee'] as String?,
