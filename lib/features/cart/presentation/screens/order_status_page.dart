                      ...
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            _buildSmallCircleButton(PhosphorIconsFill.phoneCall),
                            const SizedBox(width: 6),
                            _buildSmallCircleButton(PhosphorIconsFill.chatCircleText),
                          ],
                        ),
                        const SizedBox(height: 24),
                        Row(
    ...
    return Stack(
      children: [
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            _buildStepNode(1, PhosphorIconsFill.package),
            _buildStepNode(2, PhosphorIconsFill.cookingPot),
            _buildStepNode(3, PhosphorIconsFill.bicycle),
