  ...
  _VisaCategory(
    ...
    items: [
      _VisaItem(
        ...
        imageUrl:
            'https://images.unsplash.com/photo-1563514755193-4e42a8bce736?q=80&w=800&auto=format&fit=crop',
        description:
            'Passport holders from 93 countries and territories can enter Thailand without a visa for tourism and short-term business purposes. You will be granted an initial stay of up to 60 days upon arrival, which can be extended for an additional 30 days at the local Immigration Office. Always ensure your passport is valid for at least 6 months.',
        officialWebsite:
      ...
      _VisaItem(
        ...
        description:
            'The Tourist Visa (TR) allows visitors to stay in Thailand for up to 60 days for tourism purposes. You must apply for this visa from a Thai embassy or consulate outside of Thailand before you travel. In many countries, this can now be done via the official e-Visa portal.',
      ...
      _VisaItem(
        ...
        description:
            'Passports holders from eligible countries (who do not qualify for the 60-day exemption) can apply for a Visa on Arrival at major international airports in Thailand. This visa costs 2,000 THB and grants a 15-day stay. You must provide a confirmed return ticket within 15 days and proof of accommodation.',
        officialWebsite:
  ...
  _VisaCategory(
    ...
    items: [
      ...
      _VisaItem(
        ...
        description:
            'The Non-Immigrant ED Visa is for foreigners studying full-time in Thailand, attending seminars, training sessions, or internships. You must have an acceptance letter from an accredited educational institution. The visa is initially valid for 90 days and extended periodically based on your curriculum.',
        officialWebsite: 'https://thaievisa.go.th/',
      ),
      _VisaItem(
        ...
        description:
            'The Non-Immigrant O Visa is granted to foreign dependents, spouses, and children of Thai citizens or foreign residents holding valid long-term visas. For a marriage visa, you will be required to show proof of a legitimate relationship and strict financial requirements (such as 400,000 THB in a Thai bank account or a 40,000 THB monthly income).',
      ),
      _VisaItem(
        ...
        accentColor: const Color(0xFF10B981),
        imageUrl:
            'https://images.unsplash.com/photo-1473186578172-c141e6798fec?q=80&w=800&auto=format&fit=crop',
        description:
      ...
      _VisaItem(
        ...
        subtitle:
            '10-year premium • Wealthy citizens, retirees, skilled professionals',
        icon: PhosphorIconsRegular.crown,
        accentColor: const Color(0xFF10B981),
        imageUrl:
            'https://images.unsplash.com/photo-1554224155-8d04cb21cd6c?q=80&w=800&auto=format&fit=crop',
        description:
            'The Long-Term Resident (LTR) Visa offers 10-year validity, tax exemptions, and fast-track services for high-potential foreigners. Eligible groups include wealthy global citizens, wealthy pensioners, highly-skilled professionals, and remote workers working for well-established global companies. Managed by the BOI.',
      ...
      _VisaItem(
        ...
        accentColor: const Color(0xFF10B981),
        imageUrl:
            'https://images.unsplash.com/photo-1562967914-01efa7e87832?q=80&w=800&auto=format&fit=crop',
        description:
  ...
  _ServiceCategory(
    ...
    items: [
      _ServiceItem(
        ...
        description:
            'Long-term visa holders must report their residential address to the Immigration Bureau every 90 days of continuous stay in Thailand. Getting this done late incurs a 2,000 THB fine. You can complete this report in person, by mail, or through the official Thai Immigration e-Service portal online.',
      ...
      _ServiceItem(
        ...
        description:
            'Under the Immigration Act, the property owner or landlord must report the presence of any foreigner staying at their residence within 24 hours of arrival. While the landlord usually files the TM.30 online, the foreigner must keep the TM.30 receipt in their passport for subsequent visa extensions and 90-day reporting.',
  ...
  _ServiceCategory(
    ...
    items: [
      ...
      _ServiceItem(
        ...
        description:
            'Forms TM.86 and TM.87 allow foreigners to change their visa status (e.g., from a Tourist Visa or Exemption to a Non-Immigrant Visa) without leaving Thailand. This requires at least 15 days remaining on the current stamp, and significant supporting documentation from a sponsor, employer, or family member.',
      ...
      _ServiceItem(
        ...
        description:
            'When you receive a new passport from your embassy while staying in Thailand, your existing Thai visa and entry stamps must be transferred from the old passport to the new one. This free service is done at the Immigration Office that issued your most recent visa extension or at the airport.',
  ...
  _ServiceCategory(
    ...
    items: [
      _ServiceItem(
        ...
        description:
            'Foreigners legally employed in Thailand must hold a Work Permit. The physical blue books have been heavily replaced by the Digital Work Permit (e-WP) application on smartphones. The employer must coordinate with the Ministry of Labour to secure the Work Permit before you can legally begin working.',
        icon: PhosphorIconsRegular.briefcase,
        imageUrl:
      ...
      _ServiceItem(
        ...
        description:
            'A Certificate of Residence is an official document from Immigration or your Embassy confirming your Thai address. It is frequently required for buying a vehicle, applying for a Thai driver\'s license, opening a bank account, or acquiring utilities. You must show proof of address like a lease contract and a TM.30 receipt.',
        icon: PhosphorIconsRegular.certificate,
        imageUrl:
            'https://images.unsplash.com/photo-1603796846054-e2ef6cc2878d?q=80&w=800&auto=format&fit=crop',
      ),
      _ServiceItem(
        title: 'Income Certificate',
        subtitle: 'Embassy letter verifying income',
        description:
            'An Income Certificate is an official letter from a foreign embassy verifying a foreigner\'s pension or steady monthly income from abroad. This is commonly required for Retirement Visa applications (e.g., proving monthly income of at least 65,000 THB) or Marriage Visas (40,000 THB).',
...
class _ServiceItemTile extends StatelessWidget {
  ...
  const _ServiceItemTile({required this.item, required this.accentColor});
